...
export default function SearchCharacters({ placeholder }: { placeholder: string }) {
  ...
  return (
    <div className="relative flex flex-1 flex-shrink-0">
      ...
      <input
        ...
        defaultValue={`${searchParams.get("characterName")?.toString() ?? ""}`}
      />
