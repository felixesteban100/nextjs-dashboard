...
//     const open = params.get('openGallery') === "true" ?? false

//     function setOpen(value: boolean) {
//         params.set('openGallery', value.toString())
...
//     const labels = {
//         title: "Beautiful Work",
//         title2: "Beautiful Work",
//         title3: "Beautiful Work",
//         title4: "Beautiful Work",
//         title5: "Beautiful Work",
//         title6: "Beautiful Work",
//     }


//     return (
//         <div className="w-[80vw] max-w-[1500px] max-h-[90vh] overflow-y-scroll xl:overflow-hidden">
//             {/* <div className=" ">
...
//                                             <Plus className="text-5xl border w-16 h-16 bg-neutral-500 hover:bg-white hover:text-black p-3 cursor-pointer rounded-full" />
//                                         </p>
//                                     </div>
//                                 </div>
//                             </div>
